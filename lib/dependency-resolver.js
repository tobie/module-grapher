  ...
  function fromModule(module, callback) {
    ...
    module.resolve(self, function(err) {
      if (err) {
        ...
        self.resolveModules(module.directDependencies, {}, callback);
      }
    });
  }
      ...
      if (id in accumulator) {
        ...
        module.resolve(self, function(err) {
          if (err) {
            ...
            self.resolveModules(module.directDependencies, accumulator, cont);
          }
        });
      }
    }, function() {
      ...
      if (err) {
        ...
        fs.readFile(p, 'utf8', function (err, src) {
          if (err || src == null) {
            ...
            module.src = src;
            try {
              module.directDependencies = self.parse(src, module);
              callback(null);
            } catch(err) {
              callback(err);
            }
