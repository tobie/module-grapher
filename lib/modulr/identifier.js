      ...
      switch (term) {
        ...
        case '..':
          if (output.length) {
            ...
            throw new Error('Out of bounds identifier: "' + this + '".');
          }
          break;
        default:
          output.push(term);
...
exports.createIdentifierFromString = createIdentifierFromString;
function createIdentifierFromString(identifier) {
